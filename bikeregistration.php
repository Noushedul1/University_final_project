  ...
  try{
    ...
    if(isset($_POST['submit'])) {
      if(($_POST['firstname']=="") || ($_POST['company']=="")){
        ...
        $sql = "INSERT INTO bikeregistration(firstname, lastname, city, service, company) 
        VALUES('$firstname', '$lastname', '$city', '$service', '$company')";
        $result = $conn->exec($sql);
        echo "inserted bike value.".$result;
      }
    }
  }
...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavDropdown">
    ...
    <!-- End for header -->
    <!-- Start for bike registration -->
    <section id="bikeregistration">
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-12 col-sm-6 col-md-4">
             <form class="form-container border" action="" method="POST">
              <p class="text-center"><i class="fas fa-motorcycle"> Bike</i></p>
                <div class="form-group">
                  <div class="msg"></div>
                  <label for="firstname">First Name <span>&star;</span></label>
                  <input type="text" name="firstname" class="form-control" id="firstname" placeholder="Noushed" required>
                </div>
                <div class="form-group">
                  <div class="msg"></div>
                  <label for="lastname">Last Name</label>
                  <input type="text" name="lastname" class="form-control" id="lastname" placeholder="Akib">
                </div>
                <div class="form-group">
                  <div class="msg"></div>
